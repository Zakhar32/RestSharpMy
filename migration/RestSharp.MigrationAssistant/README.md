...
| RSM010 | `[SerializeAs]` / `[DeserializeAs]` (XML-only) | `[JsonPropertyName]` / `[JsonProperty]` | yes (Name-only) |
| RSM011 | legacy + modern serialization attribute on one member | keep one | no |
